...
import { Button, Col, Divider, Input, List, Row, Select, Skeleton, Space, Tabs, Tag, Typography, message } from "antd";
...
export default function MacroIntelPage() {
  ...
  return (
    <PageContainer title="Macro Intelligence" subtitle="Macro reasoning, news aggregation, and cross-asset context">
      <Row gutter={[16, 16]}>
          ...
          <div style={{ position: "sticky", top: 16 }}>
            ...
            >
              <Space orientation="vertical" size={10} style={{ width: "100%" }}>
                ...
                <Typography.Text type="secondary">News (Google RSS)</Typography.Text>
                <Space wrap>
                ...
                },
                {
                  ...
                  children:
                    newsState === "loading" ? (
                      ...
                      <EmptyState title="No news fetched" description="Fetch news from Google RSS." actionText="Fetch news" onAction={runNews} />
                    ),
                },
              ]}
            />
